...
-(void) cleanDataModel{
    ...
    self.dataModel = [[EVSDataModel alloc] init];
    [self.dataModel load];
}
 ...
 *  异步请求(扩展)
 */
-(void) request:(void (^)(EVSDataModel * _Nonnull)) successDataModel progress:(void (^)(NSProgress * _Nonnull))downloadProgress error:(void (^)(EVSDataModel * _Nonnull))failDataModel newServerAddress:(NSString *) newServerAddress{
    if (newServerAddress) {
        self.dataModel.serverAddress = newServerAddress;
    }
...
//异步请求
-(void) request:(void (^)(EVSDataModel * _Nonnull)) successDataModel progress:(void (^)(NSProgress * _Nonnull))downloadProgress error:(void (^)(EVSDataModel * _Nonnull))failDataModel{
...
//错误信息集中处理
-(void) showFailTips:(EVSDataModel *) dataModel{
